...
> {
  ...
  public readonly proyecto: BelongsToAccessor<Proyecto, typeof Bloque.prototype.Id_bloque>;

  public readonly inmuebles: HasManyRepositoryFactory<Inmueble, typeof Bloque.prototype.Id_bloque>;
